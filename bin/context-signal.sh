...
# (Floors sealed before the hook rename invoked it through a since-removed compat
# symlink under the retired basename; every live floor now names this file directly.)
...
# context_quality.band_of is the single source (grade-first, 2026-07-01: fires iff
...
# this hook only RENDERS the band. Rationale, thresholds and the revert path live
# on band_of's comment block + CTX-MONITOR.md "Grade-first gate".
try:
